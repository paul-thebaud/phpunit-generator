 ...
 */
interface PhpFileModelInterface extends NameInterface, NamespaceInterface
{
    /**
     * @param string $path The new path to this file.
     */
    public function setPath(string $path): void;

    /**
     * @return string The path to the file, from the source directory.
     */
