    ...
    if (! $hasCustomConstructor) {
        if ($classLike instanceof \PhpUnitGen\Model\ModelInterface\ClassModelInterface) {
            if ($classLike->isAbstract()) {
                echo $this->fetch('partial/fixture/abstract.php', ['class' => $classLike, 'parameters' => $parameters, 'auto' => $autoGeneratedParameters]);
            } else {
                echo $this->fetch('partial/fixture/class.php', ['class' => $classLike, 'parameters' => $parameters, 'auto' => $autoGeneratedParameters]);
            }
        } else if ($classLike instanceof \PhpUnitGen\Model\ModelInterface\TraitModelInterface) {
            echo $this->fetch('partial/fixture/trait.php', ['trait' => $classLike, 'parameters' => $parameters, 'auto' => $autoGeneratedParameters]);
        } else if ($classLike instanceof \PhpUnitGen\Model\ModelInterface\InterfaceModelInterface) {
            echo $this->fetch('partial/fixture/interface.php', ['interface' => $classLike, 'parameters' => $parameters, 'auto' => $autoGeneratedParameters]);
        }
    }
} ?>
